...
class SpatialFeature(nn.Module):
    ...
    def forward(self, x):
        ...
        for i in range(self.num_part):
            ...
            feat_reverse = self.TransLocal_reverse(torch.flip(single_feats[i], dims=[1]))#时序反转
...
class embed_net(nn.Module):
    def __init__(self, args, class_num, drop=0.2, no_local='on', gm_pool='on', arch='resnet50'):
        ...
        self.SpatialFeature = SpatialFeature(args, num_stripes=3, embed_dim=pool_dim,  seq_len=10, class_num=class_num)
