...
from tools.eval_metrics import eval_sysu, eval_regdb, evaluate
from model.model_main import embed_net
from tools.utils import *
from tools.loss import OriTripletLoss
from torch.optim import lr_scheduler
from tensorboardX import SummaryWriter
import torch.nn.functional as F
import math
from data.data_manager import VCM
from data.data_loader import VideoDataset_train, VideoDataset_test, VideoDataset_train_evaluation
...
parser.add_argument('--resume', '-r', default='end.t', type=str,
                    help='resume from checkpoint')

parser.add_argument('--test-only', action='store_true', help='test only')
parser.add_argument('--model_path', default='/root/autodl-tmp/', type=str,
